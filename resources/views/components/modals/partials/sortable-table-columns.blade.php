<div class="sortable-columns">
    @foreach ($columns as $column)
        <div class="sortable-columns__item" data-column-name="{{ $column['name'] }}">
            ...
            <x-form.groups.invalidateable class="form-group--horizontal" label="{{ __('Visible') }}">
                <input class="switch" type="checkbox" value="1" @checked($column['visible'])>
            </x-form.groups.invalidateable>

            <x-form.groups.invalidateable class="form-group--horizontal" label="{{ __('Width in pixels') }}">
